...
public class MeatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        foodlist.add(new FoodItem("Streaky bacon","m000",2.40, R.drawable.bacon,1));
        foodlist.add(new FoodItem("Chicken nuggets","m001",2.65,R.drawable.chickennuggets,1));
        foodlist.add(new FoodItem("T-bone steak","m002",10.50,R.drawable.tbonesteak,1));
        foodlist.add(new FoodItem("Italian sausage","m003",4.30,R.drawable.italiansausage,1));
        foodlist.add(new FoodItem("Organic beef ribs","m004",12.00,R.drawable.beefrib,1));
        foodlist.add(new FoodItem("Chilli chicken wings","m005",3.20,R.drawable.chilliwings,1));
